...
public class PerformanceSink extends RichSinkFunction<Integer> {

    private String counterPath;
    private String argString;
    private transient PerformanceCounter pCounter;

    public PerformanceSink(String counterPath, String argString){
    ...
    public void open(Configuration parameters) throws Exception {
        pCounter = new PerformanceCounter("pc", 1000, 1000, 30000,
                counterPath + "flink-" + argString + "-" + getRuntimeContext().getIndexOfThisSubtask() + ".csv");
    }
