...
public class EdgeSource extends SourceFunction<Tuple3<Integer, Integer, Integer>>{
	private static final long serialVersionUID = 1L;
	
	private final String path;
	private Tuple3<Integer, Integer, Integer> outTuple = new Tuple3<Integer, Integer, Integer>();
	
	public EdgeSource(String path) {
		this.path = path;
	}
	...
	public void invoke(Collector<Tuple3<Integer, Integer, Integer>> collector) throws IOException {
		//while(true) {
			...
			while (line != null) {
				...
				Integer addRemove = Integer.valueOf(words[2]);
	
				outTuple.f0 = from;
				outTuple.f1 = to;
				outTuple.f2 = addRemove;
