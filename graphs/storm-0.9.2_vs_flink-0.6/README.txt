...
The sink contains a logger that logs the number of words recieved every second, and outputs the data into a csv file every 30 seconds.
...
The graph shows the performance of storm in green and flink in blue.
