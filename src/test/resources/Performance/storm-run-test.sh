...
if [ -d "${toDir}" ] ; then
	...
	ssh -n storm@dell150.ilab.sztaki.hu "timeout ${length} ./${stormDir}/bin/storm jar ./$stormDir/lib/${jarFile} storm.performance.WordCountTopology cluster /home/storm/${stormDir}/resources/hamlet.txt /home/storm/${stormDir}/log/counter/ ${paramsWithSpace}"
